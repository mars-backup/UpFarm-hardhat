...
contract StrategyMars is Strategy {
    constructor(
    ...
    function _farm(uint256 wantAmt) internal override {
        ...
        ILiquidityMiningMaster(farmContractAddress).deposit(pid, wantAmt);
    }

    function _unfarm(uint256 _wantAmt) internal override {
        ILiquidityMiningMaster(farmContractAddress).withdraw(pid, _wantAmt);
    }
