...
contract UpToken is ERC20, CoreRef {
    using SafeMath for uint256;

    uint internal _cap = 1_000_000_000e18;

    constructor(address _treasury, address core_) public ERC20("UP Token", "UP") CoreRef(core_) {
    ...
    function increaseCap(uint256 _increaseNum) external onlyGovernor {
    ...
    event IncreaseCap(address operator,uint256 _increaseNum);
}