...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const master = await getOrNull("LiquidityMiningMasterBTCB")
  if (master) {
    log(`reusing "LiquidityMiningMasterBTCB" at ${master.address}`)
  } else {
    await deploy("LiquidityMiningMasterBTCB", {
      from: deployer,
...
export default func
func.tags = ["LiquidityMiningMasterBTCB"]
